...
/**
 * Estructura estándar del paquete spatie/laravel-permission corregida para evitar límite de bytes.
 */
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            // Agregamos un límite de 125 caracteres para evitar superar los 1000 bytes en el índice único
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            ...
            // Agregamos el mismo límite aquí para mantener consistencia
            $table->string('name', 125);       
            $table->string('guard_name', 125); 
            $table->timestamps();
            $teams
