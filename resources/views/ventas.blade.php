...
@php
    $iconoPorProducto = function ($producto) {
        ...
        return match (true) {
            ...
            str_contains($nombre, 'juguete')    => 'fa-baseball',
            str_contains($nombre, 'arena')      => 'fa-cubes',
            str_contains($nombre, 'antipulga')  => 'fa-bug-slash',
            default                              => 'fa-capsules',
        };
    };
@endphp
...
@section('content')
    ...
    <div class="vc-page-header">
        <div class="vc-page-header__left">
            <span class="vc-page-icon" style="background: var(--vc-blue-soft); color: var(--vc-blue);"><i class="fa-solid fa-cart-shopping"></i></span>
            <div>
                <h1>Ventas / POS</h1>
        ...
        <div class="vc-breadcrumb">
            <a href="{{ route('dashboard') }}">Inicio</a> &rsaquo; <a href="#">Ventas</a> &rsaquo; <span class="current">POS</span>
        </div>
    </div>

    @if (!$cajaActual)
        <div class="alert alert-warning d-flex align-items-center justify-content-between mb-3">
            <span><i class="fa-solid fa-triangle-exclamation"></i> No tienes una caja abierta. Debes abrir caja antes de registrar ventas.</span>
    ...
    <div class="vc-pos-layout">
        ...
        <div>
            <div class="vc-pos-tabs">
                <button type="button" class="is-active" data-tab="producto"><i class="fa-solid fa-cart-shopping"></i> Productos</button>
                <button type="button" data-tab="servicio"><i class="fa-solid fa-screwdriver-wrench"></i> Servicios</button>
                <button type="button" data-tab="paquete"><i class="fa-solid fa-box-open"></i> Paquetes</button>
            </div>
            ...
            <div class="vc-pos-search">
                ...
                <button type="button" class="scan-btn"><i class="fa-solid fa-barcode"></i></button>
            </div>
            ...
            <div class="vc-product-grid" id="gridProductos">
                @foreach ($productos as $producto)
                    <div class="vc-product-card {{ $producto->stock <= 0 ? 'is-agotado' : '' }}"
                        ...
                        <div class="vc-product-card__img"><i class="fa-solid {{ $iconoPorProducto($producto) }}" style="color: var(--vc-blue)"></i></div>
                        ...
                        <button type="button" class="vc-product-card__add"><i class="fa-solid fa-plus"></i></button>
                    </div>
                @endforeach
                ...
                @foreach ($servicios as $producto)
                    <div class="vc-product-card d-none"
                        ...
                        <div class="vc-product-card__img"><i class="fa-solid fa-stethoscope" style="color: var(--vc-teal)"></i></div>
                        <div class="vc-product-card__name">{{ $producto->nombre }}</div>
                ...
                @foreach ($paquetes as $producto)
                    <div class="vc-product-card d-none"
                        ...
                        <div class="vc-product-card__img"><i class="fa-solid fa-box-open" style="color: var(--vc-purple)"></i></div>
                        <div class="vc-product-card__name">{{ $producto->nombre }}</div>
        ...
        <div class="vc-cart-panel">
            <div class="vc-cart-header">
                ...
                <button type="button" id="btnVaciarCarrito"><i class="fa-solid fa-trash"></i></button>
            </div>
            ...
            <div class="vc-cart-body">
                ...
                <div class="vc-payment-methods" id="metodosPago">
                    <button type="button" class="is-active" data-metodo="efectivo"><i class="fa-solid fa-money-bill-wave"></i> Efectivo</button>
                    <button type="button" data-metodo="tarjeta"><i class="fa-regular fa-credit-card"></i> Tarjeta</button>
                    <button type="button" data-metodo="transferencia"><i class="fa-solid fa-building-columns"></i> Transferencia</button>
                    <button type="button" data-metodo="mixto"><i class="fa-solid fa-shuffle"></i> Mixto</button>
                </div>
            ...
            <div class="vc-cart-footer">
                <button type="button" class="vc-btn-cobrar mb-2" style="width:100%" id="btnCobrar" {{ !$cajaActual ? 'disabled' : '' }}>
                    <i class="fa-solid fa-money-bill"></i> Cobrar <span id="btnCobrarTotal">$0</span>
                </button>
                <button type="button" class="vc-btn-guardar" style="width:100%" id="btnGuardarVenta" {{ !$cajaActual ? 'disabled' : '' }}>
                    <i class="fa-regular fa-floppy-disk"></i> Guardar Venta
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content" style="border-radius:16px;border:none;">
                <form action="{{ route('caja.abrir') }}" method="POST">
                    ...
                    <div class="modal-header" style="border-bottom:1px solid var(--vc-border)">
                        <h5 class="modal-title" style="font-weight:700;font-size:15px;"><i class="fa-solid fa-cash-register"></i> Abrir Caja</h5>
                    ...
                    <div class="modal-footer" style="border-top:1px solid var(--vc-border)">
                        ...
                        <button type="submit" class="vc-btn vc-btn-success"><i class="fa-solid fa-check"></i> Abrir Caja</button>
                    </div>
                </form>
            </div>
        </div>
